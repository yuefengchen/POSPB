...
parameter.imdirformat = './/data//VTD_dataset//soccer//imgs//frame_%04d.jpg';
% demo main function
% part based model
% top , bottom, left , right
%
...
if  parameter.boost
    parameter.imsavedir = './/data//VTD_dataset//soccer//boost//frame_%04d.jpg';
...
if parameter.spboost
    sstrongclassifier = sp_sstrongclassifier;
    parameter = sp_parameter;
    parameter.imsavedir = './/data//VTD_dataset//soccer//partbasedspboost//frame_%04d.jpg';
...
save soccer_error_boost.mat error_boost;
save soccer_error_spboost.mat error_spboost;
save soccer_success_boost.mat success_boost;
save soccer_success_spboost.mat success_spboost;
save soccer_location_boost.mat location_boost;
save soccer_location_spboost.mat location_spboost;